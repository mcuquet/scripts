...
my $scriptdescription = "Remove dependence on package qphys";
...
my $name = "qphys.sty";
my $number = 0;
my $path = "/usr/local/texlive/texmf-local/tex/latex/";
...
Searches 'file' for commands appearing in 'package_name', comments line
